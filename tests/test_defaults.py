...
from codewatch.defaults import create_directory_filter, create_file_filter


@pytest.mark.parametrize(
    "dir_name,directory_filters,expected_output",
    [
...
def test_create_directory_filter(dir_name, directory_filters, expected_output):
    dir_filter = create_directory_filter(directory_filters)
    assert dir_filter(dir_name) == expected_output


@pytest.mark.parametrize(
    "file_name,file_filters,expected_output",
    [
